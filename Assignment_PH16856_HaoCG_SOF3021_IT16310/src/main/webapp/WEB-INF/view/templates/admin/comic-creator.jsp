            	...
            	<div class="row g-4">
					<div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Tạo mới sản phẩm</h6>
                            <div class="table-responsive">
                               	<form:form method="POST"
									action="/admin/comics/store" modelAttribute="comic">
								
									<div class="mb-3">
										<label for="ten" class="form-label">Tên truyện</label> <input
											type="text" class="form-control" aria-describedby="tenHelp"
											name="comicName">
									</div>
								
									<div class="mb-3">
										<label for="currentQuantity" class="form-label">Số lượng</label> <input
											type="number" class="form-control" name="currentQuantity">
									</div>
								
									<div class="mb-3">
										<label for="currentPrice" class="form-label">Đơn giá </label> <input
											type="number" class="form-control" name="currentPrice">
									</div>
								
									<div class="mb-3">
										<label for="chapter" class="form-label">Chương truyện</label> <input
											type="text" class="form-control" name="chapter">
									</div>
									...
									<label for="category_id" class="form-label">Danh mục</label> <select
									...
									<div class="input-group mb-3">
										<input type="file" class="form-control" id="inputGroupFile02"
											name="image"> <label class="input-group-text"
											for="inputGroupFile02">Ảnh bộ truyện</label>
									</div>								
									
									<div class="form-floating mb-3">
										<textarea name="status" class="form-control" placeholder="Leave a comment here" id="status" style="height: 100px"></textarea>
										<label for="status">Chú thích</label>
									</div>
																									
									<div class="d-grid gap-2 d-md-flex justify-content-md-end">
										<button class="btn btn-outline-dark me-md-2">Tạo</button>
										<button class="btn btn-outline-dark me-md-2" type="reset">Trắng</button>											
									</div>
								</form:form>
