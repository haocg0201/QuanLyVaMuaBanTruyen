            	...
            	<div class="row g-4">     
					<div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Hóa đơn chi tiết</h6>
                            <div class="table-responsive">
                                <table class="table table-bordered border-info">
                                    ...
                                    <tbody>
                                        <tr>
                                            <c:forEach items="${ page.getContent() }" var="orderDetail">
												<tr>
													<td>${ orderDetail.orderdetailId }</td>
													<td>${ orderDetail.order.orderId }</td>
													<td>${ orderDetail.comic.comicId }</td>
													<td>${ orderDetail.purchasedQuantity }</td>
													<td>${ orderDetail.purchasedPrice }</td>
												</tr>
											</c:forEach>
                                        </tr>                                       
                                    </tbody>
                                ...
                                <p class="text-right">
						        	<c:if test="${page.getNumber() > 0 }">
						        		<a href="/admin/order-detail?pageNumber=${page.getNumber() - 1}" class = "btn btn-primary">Previous</a>
						        	</c:if>
						        	<Strong class = "text-info"> ${ page.getNumber() + 1} </Strong> / ${page.getTotalPages()+1}
						        	<c:if test="${ page.getNumber() <= (page.getTotalPages() - 2) }">
						        		<a href="/admin/order-detail?pageNumber=${page.getNumber() + 1}"  class = "btn btn-primary">Next</a>
				        			</c:if>
				        		</p>
                            </div>
                        </div>
