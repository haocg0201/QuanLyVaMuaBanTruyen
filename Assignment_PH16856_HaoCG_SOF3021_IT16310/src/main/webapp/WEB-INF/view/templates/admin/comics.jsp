    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
            	<a href="/admin/comics/comic-creator" type="button" class="btn btn-primary">Thêm mới</a>
            	<div class="row g-4">
					<div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered border-info">
                                    ...
                                    <tbody>
                                        <tr>
                                            <c:forEach items="${ page.getContent() }" var="comic">
												<tr>
													<td>${ comic.comicId }</td>
													<td>${ comic.comicName }</td>
													<td>${ comic.currentQuantity }</td>
													<td>${ comic.currentPrice }</td>
													<td>${ comic.chapter }</td>
													<td>${ comic.author }</td>
													<td>${ comic.type }</td>
													<td> <fmt:formatDate value="${ comic.enteredDate }" pattern="dd/MM/yyyy"/> </td>
													<td> <img alt="" src="/static/admin/img/${ comic.image }" width="50%"> </td>
													<td>${ comic.status }</td>
													<td>
														<a class="btn btn-primary"
															href="/admin/comics/edit/${ comic.comicId }"> Sửa
														</a>
													</td>
													<td>
														<a class="btn btn-danger"
															href="/admin/comics/delete/${ comic.comicId }"> Xóa
														</a>
													</td>	
												</tr>
											</c:forEach>
                                ...
                                <p class="text-right">
						        	<c:if test="${page.getNumber() > 0 }">
						        		<a href="/admin/comics?pageNumber=${page.getNumber() - 1}" class = "btn btn-primary">Previous</a>
						        	</c:if>
						        	<Strong class = "text-info"> ${ page.getNumber() + 1} </Strong> / ${page.getTotalPages() }
						        	<c:if test="${ page.getNumber() <= (page.getTotalPages() - 2) }">
						        		<a href="/admin/comics?pageNumber=${page.getNumber() + 1}"  class = "btn btn-primary">Next</a>
				        			</c:if>
				        		</p>
                            </div>
                        </div>
