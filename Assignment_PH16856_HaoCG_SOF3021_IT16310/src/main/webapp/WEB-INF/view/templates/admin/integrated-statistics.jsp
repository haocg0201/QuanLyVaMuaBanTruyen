	            	...
	            	<ul class="list-unstyled templatemo-accordion">
	                    <li class="pb-3">
	            			...
	            			<ul id="collapseTwo" class="collapse list-unstyled pl-3">
	                            <li><a class="text-decoration-none" href="#ByDay">Ngày</a></li>
	                            <li><a class="text-decoration-none" href="#ByMonth">Tháng</a></li>
	                            <li><a class="text-decoration-none" href="#ByYear">Năm</a></li>
	                        </ul>
                        </li>
                      </ul>
                                ...
                                <table class="table table-bordered border-info">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Doanh thu mỗi đơn hàng</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>         
