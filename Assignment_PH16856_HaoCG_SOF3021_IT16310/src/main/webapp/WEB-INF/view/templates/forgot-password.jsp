            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form:form action="/send-password" method="Post">
	                        <div class="form-floating mb-3">
	                            <input type="email" name="usernameToSend" class="form-control" id="floatingInput" placeholder="name@example.com">
	                            <label for="floatingInput">Email address</label>
	                        </div>
	                        <div class="d-flex align-items-center justify-content-between mb-4">
	                            <a href="/admin/forgot-password">Cho vào cho đẹp chứ chẳng biết để đây là gì :v</a>
	                        </div>
	                        <button type="submit" class="btn btn-primary py-3 w-100 mb-4">Send To GMail</button>
                       </form:form>
                    </div>
                </div>
            </div>
