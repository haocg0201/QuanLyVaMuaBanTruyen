        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="/static/site/img/${comic.image }" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">${ comic.comicName}</h1>
                            <p class="h3 py-2">${comic.currentPrice }</p>
                            <p class="h4 py-2">Số Lượng còn trong kho: <strong>${comic.currentQuantity }</strong></p>
                            <p class="py-2">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>${comic.type}</strong></p>
                                </li>
                            </ul>
                            ...
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6>Màu gì đó chứ không phải truyện này đâu </h6>
                                </li>
                                <li class="list-inline-item">
                                   ...
                                   <!--   <div class="col-auto">
                                    ...
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
                                            ...
                                            <li> <String> Chỉ có <b>${ comic.currentQuantity }</b> quyển truyện thôi mua lắm thế </Strong></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="row pb-3">
                                    <div class="col d-grid">
                                        <a type="submit" class="btn btn-success btn-lg"  href="#">Để cho vui chứ chưa biết làm gì</a>
                                    </div>
                                    <div class="col d-grid">
                                        <a type="submit" class="btn btn-success btn-lg" href="/home/shopping-cart/${comic.comicId }" >Add To Cart</a>
                                    </div>
                                </div>
                            </form>
