                                        ...
                                        <tr>
                                            <c:forEach items="${ lstOrder }" var="order">
												<tr>
													...
													<td>
														<c:choose>
															<c:when test="${order.status == 0 }"><Strong class="text-primary"> Chưa xác nhận </Strong></c:when>
															<c:when test="${order.status == 1 }"><Strong class="text-success"> Đã xác nhận </Strong></c:when>
															<c:otherwise><Strong class="text-danger"> Đã hủy </Strong></c:otherwise>
														</c:choose>
													</td>
													<td>
													<c:if test="${ order.status != 2}">
														<a class="btn btn-warning"
															href="/home/account-order/edit/${ order.orderId }/2"> Hủy
														</a>
													</c:if>
													</td>	
												</tr>
